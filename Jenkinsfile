      ...
      parallel{
        stage('Web'){
          steps{
            ...
            sh "docker cp ${CONTAINER_NAME}:/usr/work/src/Web/bin/Publish/Web ${env.WORKSPACE}/src/bin/Publish/"
          }
        }
        stage('Api'){
          steps{
            ...
            sh "docker cp ${CONTAINER_NAME}:/usr/work/src/PublicApi/bin/Publish/PublicApi ${env.WORKSPACE}/src/bin/Publish/"
          }
        }
      }
    }
